...
tape("exifReader", function (t: tape.Test): void {
    ...
    t.test("getCreateDate", function (t: tape.Test): void {
        ...
        t.test("will read the creation date from an iPhone imae", function (t: tape.Test): void {
        ...
        t.test("will read the creation date from a Canon imae", function (t: tape.Test): void {
        ...
        t.test("will read the creation date from a Panasonic imae", function (t: tape.Test): void {
